 ...
 */
package org.foi.nwtis.hcosic2.ejb.eb;
...
/**
 * Klasa entiteta Dnevnik koja definira upite
 * @author Hrvoje
 */
@Entity
@Table(name = "DNEVNIK")
...
public class Dnevnik implements Serializable {
    ...
    public Dnevnik(String korisnik, String url, String ipadresa, Date vrijeme, int trajanje, int status) {
    ...
    /**
     * Funckija za usporedbu objekta s prosljeđenim objektom
     * @param object objekt koji treba usporediti
     * @return 
     */
    @Override
    ...
    /**
     * Fukcija koja ispisuje objekt u obliku stringa
     * @return string objekta i njegovo ID-a
     */
    @Override
    public String toString() {
        return "org.foi.nwtis.hcosic2.ejb.eb.Dnevnik[ id=" + id + " ]";
    }
